export const schoolData = {
    portuguese: {
        ...
        schooling: [
            {
                name: 'UFES - Mestrado em Engenharia Elétrica - Telecomunicações e Tecnologia da Informação (TTI)',
        ...
        courses: [
            {
                name: 'Udemy - Séries Temporais e Análises Preditivas com Python',
            ...
            },
            {
                ...
                links: [
                    {
                        name: 'Certificado do curso HTML e CSS: O Início (incluindo 5 Projetos)',
            ...
            },
            {
                ...
                links: [
                    {
                        name: 'Certificado do curso Introdução à Internet das Coisas',
                ...
                links: [
                    {
                        name: 'Certificado do curso Aplicativos para dispositivos móveis',
                ...
                links: [
                    {
                        name: 'Certificado do curso Desvendando a Indústria 4.0',
    ...
    english: {
        ...
        courses: [
            ...
            },
            {
                ...
                links: [
                    {
                        name: 'Certificate for the course Mastering 3D Modeling With Blender For Beginners',
                        ref: 'https://www.udemy.com/certificate/UC-T55B410T/',
                    },
                ],
                ...
                links: [
                    {
                        name: 'Certificate of the course Learn JavaScript with Fun - Build an UFO Hunter Game',
                        ref: 'https://www.udemy.com/certificate/UC-DHVLQAA1/',
                    },
                ],
